...
/** 
* @author ym: 
* @version 创建时间：2019年11月19日 下午4:46:02 
* @description 注解处理器
*/
import java.io.*;
...
@SupportedAnnotationTypes("com.ym.annotation.Adapt")
...
public class AdaptProcessor extends AbstractProcessor {
  ...
  public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
    for (TypeElement annotation : annotations) {
      if (!"com.ym.annotation.Adapt".equals(annotation.getQualifiedName().toString())) {
        continue;
      }
