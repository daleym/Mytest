...
prog="$2"
prog_jar="$3"
prog_zkaddr="192.168.9.151:2181"
...
#if [ $prog == "ProductApp" ]; then
#        JAVA_OPTS="$JAVA_OPTS -DexJvmArgs=-Xdebug -Xnoagent -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=7771 "
#	JAVA_OPTS="$JAVA_OPTS -Dcom.sun.management.jmxremote.port=9998 "
#	JAVA_OPTS="$JAVA_OPTS -Dcom.sun.management.jmxremote.ssl=false "  
#	JAVA_OPTS="$JAVA_OPTS  -Dcom.sun.management.jmxremote.authenticate=false "
#elif [  $prog == "ProductSchedule" ]; then
#	JAVA_OPTS="$JAVA_OPTS -DexJvmArgs=-Xdebug -Xnoagent -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=9991 " 
#fi
